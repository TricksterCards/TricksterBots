// last updated 11/29/2023 12:42 PM (-06:00)
        ...
        public static readonly Dictionary<string, SaycResult[]> Results = new Dictionary<string, SaycResult[]>
        {
             ...
             },
             {
                "test_jacoby_transfers", new[]
                {
                    ...
                    new SaycResult(true, 429, 429),
                    new SaycResult(true, 432, 432),
                    new SaycResult(false, 437, 440), // last run result: 4♣; expected: 4♥;
                    new SaycResult(true, 430, 430),
                    new SaycResult(false, 437, 438), // last run result: 4♣; expected: 4♦;
                    new SaycResult(true, -2, -2),
             ...
             },
             {
                "test_slam_invitations_over_one_nt", new[]
                {
                    ...
                    new SaycResult(false, 422, 432), // last run result: 2♦; expected: 3♥;
             ...
             },
             {
                "test_rule_of_twenty_open", new[]
                {
                    ...
                    new SaycResult(false, -2, 415), // last run result: Pass; expected: 1♠;
                    new SaycResult(true, 414, 414),
             ...
             },
             {
                "test_minimum_response_to_one_of_a_major", new[]
                {
                    ...
                    new SaycResult(true, 423, 423),
                    new SaycResult(true, 412, 412),
                    new SaycResult(false, 424, 440), // last run result: 2♥; expected: 4♥;
                    new SaycResult(true, -2, -2),
                }
             },
             {
                "test_invitational_response_to_one_of_a_major", new[]
                {
                    ...
                    new SaycResult(false, 415, 432), // last run result: 1♠; expected: 3♥;
                    new SaycResult(true, 421, 421),
                }
             },
             {
             ...
             },
             {
                "test_jacoby_two_nt_response_to_one_of_a_major", new[]
                {
                    ...
                    new SaycResult(false, 437, 432), // last run result: 4♣; expected: 3♥;
                    ...
                    new SaycResult(false, 431, 429), // last run result: 3♠; expected: 3♣;
                    new SaycResult(false, 428, 429), // last run result: 3NT; expected: 3♣;
                }
             },
             {
             ...
             },
             {
                ...
                {
                    new SaycResult(true, 415, 415),
                    new SaycResult(false, 420, 412), // last run result: 2NT; expected: 1NT;
                    new SaycResult(true, 414, 414),
             ...
             },
             {
                "test_invitational_rebid_by_opener", new[]
                {
                    ...
                    new SaycResult(false, 431, 420), // last run result: 3♠; expected: 2NT;
                    new SaycResult(false, 431, 420), // last run result: 3♠; expected: 2NT;
                    new SaycResult(false, 432, 420), // last run result: 3♥; expected: 2NT;
                    new SaycResult(false, 432, 430), // last run result: 3♥; expected: 3♦;
                    new SaycResult(true, 432, 432),
             ...
             },
             {
                "test_reverses", new[]
                {
                    ...
                    new SaycResult(false, 428, 430), // last run result: 3NT; expected: 3♦;
                    new SaycResult(true, 420, 420),
                    new SaycResult(false, 428, 422), // last run result: 3NT; expected: 2♦;
                    new SaycResult(false, 428, 422), // last run result: 3NT; expected: 2♦;
             ...
             },
             {
                "test_subsequent_bidding_by_responder", new[]
                {
                    ...
                    new SaycResult(false, 428, 440), // last run result: 3NT; expected: 4♥;
                    new SaycResult(false, 428, 424), // last run result: 3NT; expected: 2♥;
                    new SaycResult(false, 428, 432), // last run result: 3NT; expected: 3♥;
                    new SaycResult(true, 428, 428),
                    new SaycResult(true, 439, 439),
                    new SaycResult(false, 428, 446), // last run result: 3NT; expected: 5♦;
                    new SaycResult(false, -2, 440), // last run result: Pass; expected: 4♥;
                    new SaycResult(false, 428, 440), // last run result: 3NT; expected: 4♥;
                    new SaycResult(false, 428, 423), // last run result: 3NT; expected: 2♠;
                    new SaycResult(true, 429, 429),
             ...
             },
             {
                "test_fourth_suit_forcing", new[]
                {
                    ...
                    new SaycResult(false, 429, 431), // last run result: 3♣; expected: 3♠;
             ...
             },
             {
                "test_preemption", new[]
                {
                    ...
                    new SaycResult(false, 431, -2), // last run result: 3♠; expected: Pass;
                    new SaycResult(true, 431, 431),
                    new SaycResult(false, 431, 415), // last run result: 3♠; expected: 1♠;
                    new SaycResult(true, 432, 432),
                    new SaycResult(true, 432, 432),
                    new SaycResult(true, 432, 432),
                    new SaycResult(false, 432, -2), // last run result: 3♥; expected: Pass;
                    ...
                    new SaycResult(true, 439, 439),
                    new SaycResult(true, 439, 439),
                    new SaycResult(false, 439, 415), // last run result: 4♠; expected: 1♠;
                    new SaycResult(true, 415, 415),
                    new SaycResult(false, 432, 440), // last run result: 3♥; expected: 4♥;
                    new SaycResult(false, 432, 440), // last run result: 3♥; expected: 4♥;
                    new SaycResult(false, 432, 440), // last run result: 3♥; expected: 4♥;
             ...
             },
             {
                "test_strong_two_club", new[]
                {
                    ...
                    new SaycResult(true, 428, 428),
                    new SaycResult(true, 424, 424),
                    new SaycResult(false, 438, -2), // last run result: 4♦; expected: Pass;
                    new SaycResult(true, -2, -2),
                }
             },
             {
                "test_overcalls", new[]
                {
                    ...
                    new SaycResult(false, 424, -2), // last run result: 2♥; expected: Pass;
                    new SaycResult(false, -2, 424), // last run result: Pass; expected: 2♥;
                    new SaycResult(false, 421, 424), // last run result: 2♣; expected: 2♥;
             ...
             },
             {
                ...
                {
                    new SaycResult(true, -2, -2),
                    new SaycResult(false, 416, 421), // last run result: 1♥; expected: 2♣;
                    new SaycResult(false, 416, 422), // last run result: 1♥; expected: 2♦;
                    new SaycResult(false, 436, 439), // last run result: 4NT; expected: 4♠;
                    new SaycResult(false, 415, 421), // last run result: 1♠; expected: 2♣;
                    new SaycResult(false, 415, 422), // last run result: 1♠; expected: 2♦;
                    new SaycResult(true, 415, 415),
                    new SaycResult(false, 436, 430), // last run result: 4NT; expected: 3♦;
                    new SaycResult(false, 416, 415), // last run result: 1♥; expected: 1♠;
                    new SaycResult(false, 416, 415), // last run result: 1♥; expected: 1♠;
                    new SaycResult(false, 402, 421), // last run result: X; expected: 2♣;
             ...
             },
             {
                "test_responses_to_michaels", new[]
                {
                    new SaycResult(false, -2, 429), // last run result: Pass; expected: 3♣;
                    new SaycResult(false, -2, 430), // last run result: Pass; expected: 3♦;
                    new SaycResult(false, 436, -2), // last run result: 4NT; expected: Pass;
                    new SaycResult(false, 436, 438), // last run result: 4NT; expected: 4♦;
                    new SaycResult(true, 445, 445),
             ...
             },
             {
                "test_overcalling_one_notrump", new[]
                {
                    ...
                    new SaycResult(false, 424, 422), // last run result: 2♥; expected: 2♦;
                    new SaycResult(false, 421, 424), // last run result: 2♣; expected: 2♥;
                    new SaycResult(false, 422, 423), // last run result: 2♦; expected: 2♠;
                    new SaycResult(false, 421, 420), // last run result: 2♣; expected: 2NT;
                    new SaycResult(false, 421, 429), // last run result: 2♣; expected: 3♣;
                    new SaycResult(true, -2, -2),
                    new SaycResult(false, -2, 422), // last run result: Pass; expected: 2♦;
             ...
             },
             {
                "test_doubles", new[]
                {
                    ...
                    new SaycResult(false, 439, 423), // last run result: 4♠; expected: 2♠;
                    new SaycResult(false, -2, 431), // last run result: Pass; expected: 3♠;
                    new SaycResult(false, -2, 412), // last run result: Pass; expected: 1NT;
                    new SaycResult(false, -2, 420), // last run result: Pass; expected: 2NT;
                    new SaycResult(false, -2, 420), // last run result: Pass; expected: 2NT;
                    ...
                    new SaycResult(false, -2, 428), // last run result: Pass; expected: 3NT;
                    new SaycResult(false, 431, 423), // last run result: 3♠; expected: 2♠;
                    new SaycResult(false, 430, 412), // last run result: 3♦; expected: 1NT;
                    new SaycResult(true, 422, 422),
                    new SaycResult(false, 431, 423), // last run result: 3♠; expected: 2♠;
                    new SaycResult(false, -2, 416), // last run result: Pass; expected: 1♥;
                    new SaycResult(false, -2, 412), // last run result: Pass; expected: 1NT;
                    ...
                    new SaycResult(false, -2, 432), // last run result: Pass; expected: 3♥;
                    new SaycResult(true, 412, 412),
                    new SaycResult(false, 439, 422), // last run result: 4♠; expected: 2♦;
                    new SaycResult(true, 420, 420),
                    new SaycResult(true, 428, 428),
                    new SaycResult(true, 439, 439),
                    new SaycResult(false, -2, 431), // last run result: Pass; expected: 3♠;
                    new SaycResult(false, -2, 415), // last run result: Pass; expected: 1♠;
                    new SaycResult(false, -2, 423), // last run result: Pass; expected: 2♠;
                    new SaycResult(true, 403, 403),
                    new SaycResult(false, 422, 424), // last run result: 2♦; expected: 2♥;
                    new SaycResult(false, 424, 440), // last run result: 2♥; expected: 4♥;
                    new SaycResult(false, 403, 430), // last run result: XX; expected: 3♦;
                    new SaycResult(true, 415, 415),
                    new SaycResult(false, 424, 420), // last run result: 2♥; expected: 2NT;
                    new SaycResult(true, 432, 432),
                    new SaycResult(true, -2, -2),
                    new SaycResult(false, -2, 402), // last run result: Pass; expected: X;
                    new SaycResult(false, -2, 402), // last run result: Pass; expected: X;
             ...
             },
             {
                "test_negative_double", new[]
                {
                    ...
                    new SaycResult(false, -2, 432), // last run result: Pass; expected: 3♥;
                    new SaycResult(false, -2, 432), // last run result: Pass; expected: 3♥;
                    new SaycResult(false, 436, 428), // last run result: 4NT; expected: 3NT;
                    new SaycResult(false, 428, 440), // last run result: 3NT; expected: 4♥;
                    new SaycResult(false, 428, 439), // last run result: 3NT; expected: 4♠;
                    new SaycResult(false, 446, 420), // last run result: 5♦; expected: 2NT;
                    new SaycResult(false, -2, 432), // last run result: Pass; expected: 3♥;
                    new SaycResult(false, -2, 431), // last run result: Pass; expected: 3♠;
                    ...
                    new SaycResult(false, 428, 429), // last run result: 3NT; expected: 3♣;
                    new SaycResult(false, -2, 420), // last run result: Pass; expected: 2NT;
                    new SaycResult(false, 437, -2), // last run result: 4♣; expected: Pass;
                    new SaycResult(false, 437, 428), // last run result: 4♣; expected: 3NT;
                    new SaycResult(true, 420, 420),
                    new SaycResult(true, 428, 428),
                    new SaycResult(false, 440, 423), // last run result: 4♥; expected: 2♠;
                    new SaycResult(true, 424, 424),
                    new SaycResult(false, 439, 424), // last run result: 4♠; expected: 2♥;
                    new SaycResult(true, 424, 424),
                    new SaycResult(true, 402, 402),
                    new SaycResult(true, 423, 423),
                    new SaycResult(true, 402, 402),
                    ...
                    new SaycResult(false, -2, 402), // last run result: Pass; expected: X;
                    new SaycResult(false, -2, 423), // last run result: Pass; expected: 2♠;
                    new SaycResult(false, 438, 424), // last run result: 4♦; expected: 2♥;
                    new SaycResult(false, -2, 423), // last run result: Pass; expected: 2♠;
                    new SaycResult(false, -2, 402), // last run result: Pass; expected: X;
                    new SaycResult(false, 428, 402), // last run result: 3NT; expected: X;
                    new SaycResult(false, -2, 430), // last run result: Pass; expected: 3♦;
             ...
             },
             {
                "test_balancing", new[]
                {
                    ...
                    new SaycResult(true, 415, 415),
                    new SaycResult(true, -2, -2),
                    new SaycResult(false, 402, 412), // last run result: X; expected: 1NT;
                    new SaycResult(true, 421, 421),
                    new SaycResult(true, 420, 420),
                    new SaycResult(false, -2, 402), // last run result: Pass; expected: X;
                    new SaycResult(true, -2, -2),
             ...
             },
             {
                ...
                {
                    new SaycResult(false, 437, 436), // last run result: 4♣; expected: 4NT;
                    new SaycResult(false, -2, 452), // last run result: Pass; expected: 6NT;
                    new SaycResult(false, 437, 436), // last run result: 4♣; expected: 4NT;
                    new SaycResult(true, -2, -2),
                    new SaycResult(false, 436, 448), // last run result: 4NT; expected: 5♥;
                    new SaycResult(true, -2, -2),
                    new SaycResult(false, 436, 448), // last run result: 4NT; expected: 5♥;
                    new SaycResult(false, -2, 456), // last run result: Pass; expected: 6♥;
                    new SaycResult(false, -2, 455), // last run result: Pass; expected: 6♠;
                    new SaycResult(true, -2, -2),
                    new SaycResult(false, -2, 463), // last run result: Pass; expected: 7♠;
             ...
             },
             {
                "test_misc_hands_from_play", new[]
                {
                    ...
                    new SaycResult(true, 415, 415),
                    new SaycResult(true, -2, -2),
                    new SaycResult(false, 436, 452), // last run result: 4NT; expected: 6NT;
                    ...
                    new SaycResult(true, -2, -2),
                    new SaycResult(false, 436, 437), // last run result: 4NT; expected: 4♣;
                    new SaycResult(false, -2, 422), // last run result: Pass; expected: 2♦;
                    new SaycResult(false, -2, 412), // last run result: Pass; expected: 1NT;
                    new SaycResult(false, -2, 422), // last run result: Pass; expected: 2♦;
                    new SaycResult(false, 437, -2), // last run result: 4♣; expected: Pass;
                    new SaycResult(false, 438, -2), // last run result: 4♦; expected: Pass;
                    new SaycResult(false, 436, 440), // last run result: 4NT; expected: 4♥;
                    new SaycResult(false, -2, 432), // last run result: Pass; expected: 3♥;
                    new SaycResult(false, 431, 439), // last run result: 3♠; expected: 4♠;
                    new SaycResult(false, -2, 439), // last run result: Pass; expected: 4♠;
                    new SaycResult(false, -2, 412), // last run result: Pass; expected: 1NT;
                    new SaycResult(false, -2, 431), // last run result: Pass; expected: 3♠;
                    new SaycResult(true, 412, 412),
                    new SaycResult(false, 436, 444), // last run result: 4NT; expected: 5NT;
                    new SaycResult(false, 421, -2), // last run result: 2♣; expected: Pass;
                    new SaycResult(false, 437, -2), // last run result: 4♣; expected: Pass;
                    new SaycResult(false, -2, 452), // last run result: Pass; expected: 6NT;
                    new SaycResult(false, -2, 452), // last run result: Pass; expected: 6NT;
                    new SaycResult(true, 439, 439),
                    new SaycResult(true, -2, -2),
                    new SaycResult(false, 424, 421), // last run result: 2♥; expected: 2♣;
                    new SaycResult(false, 446, -2), // last run result: 5♦; expected: Pass;
                    new SaycResult(false, -2, 430), // last run result: Pass; expected: 3♦;
                    new SaycResult(true, -2, -2),
                    new SaycResult(true, -2, -2),
                    new SaycResult(false, -2, 428), // last run result: Pass; expected: 3NT;
                    ...
                    new SaycResult(false, -2, 402), // last run result: Pass; expected: X;
                    new SaycResult(true, 431, 431),
                    new SaycResult(false, 445, -2), // last run result: 5♣; expected: Pass;
                    new SaycResult(true, -2, -2),
                    new SaycResult(false, -2, 432), // last run result: Pass; expected: 3♥;
                    new SaycResult(false, -2, 422), // last run result: Pass; expected: 2♦;
                    new SaycResult(false, -2, 432), // last run result: Pass; expected: 3♥;
